...
const UserProfile = ({ userData }) => {
	return (
		<>
			<Flex my={16} border={"2px solid"} borderColor={"blue.500"} borderRadius={4} padding={8}>
				<VStack gap={5}>
				...
				<VStack ml={8} alignItems={"self-start"}>
					...
					<Text fontSize={"2xl"} fontWeight={"bold"} mt={4} color={"green.100"}>
						{userData.name}
					</Text>
					...
					<Box>
						<Text fontSize={"md"}>
							<Text as={"span"} fontWeight={"bold"} color={"green.100"} mr={1}>
								Company:
							</Text>
